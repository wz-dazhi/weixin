...
public class WeatherForecastUtil {
	...
	// 天气预报接口URL GET请求
	private static final String URL = "http://v.juhe.cn/weather/geo?format=2&key=d6b9e2ec408436bfeb9f5a2103950cbe&lon=116.39277&lat=39.933748";

	// 查询天气
	public static String selectWeather() {
		// 发起请求
		String json = HttpUtil.httpRequest(URL, "GET", null);
		Gson gson = new Gson();
		// 将json转成Java对象
